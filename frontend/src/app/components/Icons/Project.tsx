...
const Project: React.FC<{ size?: number }> = ({
  size = 100,
}: {
  size?: number;
}) => (
  ...
  >
    ...
    <path
      fill="#84DBFF"
      d="M147.8,251.8c-1,3.3-1.6,6.7-1.6,10.1c0,8.6,3.2,16.6,8.7,22.9h196.3c5.4-6.3,8.7-14.3,8.7-22.9
    ...
    <g>
      <path
        fill="#54C0EB"
        d="M145.7,252.4c-0.9,3.1-1.3,6.3-1.3,9.6c0,8.6,3,16.5,8.1,22.9H163c-6.9-5.7-11.1-13.9-11.1-22.9
      ...
      <path
        fill="#54C0EB"
        d="M332.5,284.9c0-0.5,0.1-1,0.1-1.5c0-21.3-18.7-38.6-41.7-38.6v7.5c18.9,0,34.2,14,34.2,31.1
		c0,0.5-0.1,1-0.1,1.5H332.5z"
      />
      <path
        fill="#54C0EB"
        d="M180.8,283.3c0-17.2,15.3-31.1,34.2-31.1v-7.5c-23,0-41.7,17.3-41.7,38.6c0,0.5,0.1,1,0.1,1.5h7.5
		C180.9,284.4,180.8,283.8,180.8,283.3z"
      />
    </g>
    <path
      fill="#CED5E0"
      d="M191.1,356.4l0.3,2.3c0.6,4.7,0.9,9.4,0.9,13.9v35.6c0,3.9,3.1,7,7,7h107.3c1.9,0,3.6-0.7,5-2
    ...
    <path
      fill="#FFD05B"
      d="M152.3,284.5c3.6,5.6,7.7,11,12.3,16.1c14.7,16.1,24,36.3,26.8,58.2l0.2,1.8h122.7l0.2-1.8
