...
import ReadOnlyMobilePendingsList from "./ReadOnlyMobilePendingsList";
...
export default function ReadOnlyTestPendingsList({
  testsPending,
}: {
  ...
  if (isSmallScreen) {
    return <ReadOnlyMobilePendingsList testsPending={testsPending} />;
  }
